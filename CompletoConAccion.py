...
def save_results(barcodes, directory):
    ...
    return result_file_path  # Devolver la ruta del archivo guardado
...
def send_to_database(result_file_path, sucursal):
    # Convertir el nombre de la sucursal en un número
    ...
    with open(result_file_path, 'r') as file:
        for line in file:
            ...
            cur.execute(
                ...
                [numero_receta, "P", sucursal_numero, fecha_creacion]
            )
